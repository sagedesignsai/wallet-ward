  ...
  return (
    <div className={cn("relative h-full w-full", className)} aria-hidden="true">
      ...
      >
        ...
        {[0, 1, 2, 3, 4].map((i) => (
          <React.Fragment key={i}>
            ...
            <circle
              ...
              cy={128 + i * 44}
              r="6"
              fill={i === 0 ? "oklch(0.7 0.16 245)" : "oklch(0.3 0.03 250)"}
              opacity={i === 0 ? 0.9 : 0.5}
            />
          </React.Fragment>
        ))}
        ...
        {/* GitHub */}
        <g
          className="animate-[float1_5s_ease-in-out_infinite]"
        ...
        <path
          d="M68 126 C80 126, 80 130, 80 130"
          stroke="oklch(0.7 0.01 0)"
          strokeWidth="1"
          strokeDasharray="3 3"
          opacity="0.4"
        ...
        {/* Linear */}
        <g
          className="animate-[float2_6s_ease-in-out_infinite]"
        ...
        <path
          d="M68 206 C80 206, 80 190, 80 190"
          stroke="oklch(0.75 0.18 300)"
          strokeWidth="1"
          strokeDasharray="3 3"
          opacity="0.4"
        ...
        {/* Vercel */}
        <g
          className="animate-[float3_5.5s_ease-in-out_infinite]"
        ...
        >
          ...
          {/* Vercel triangle */}
          <path
            d="M478 158 L498 188 L458 188 Z"
            fill="oklch(0.95 0.01 0)"
            opacity="0.8"
          />
        </g>
        ...
        {/* Slack */}
        <g
          className="animate-[float1_6.5s_ease-in-out_infinite]"
