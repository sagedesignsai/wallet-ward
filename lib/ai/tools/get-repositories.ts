 ...
 * Returns repository names, providers, sync status, and URLs.
 */
export const getRepositoriesTool = tool({
  description: "Retrieve Git repositories connected to a project. Returns repository names, providers, sync status, and URLs.",
