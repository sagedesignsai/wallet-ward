...
export const getProjectFilesTool = tool({
  description: "Retrieve files and artifacts from a project. Returns file names, types, sizes, versions, and metadata.",
  inputSchema: z.object({
    projectId: z.string().describe("The project ID"),
    type: z.enum(["artifact", "document", "config", "asset", "code", "data", "other"]).optional().describe("Optional: filter by file type"),
  }),
